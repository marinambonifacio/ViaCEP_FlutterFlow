...
class _HomePageWidgetState extends State<HomePageWidget> {
  ...
  void initState() {
    ...
    _model.textFieldRuaTextController ??= TextEditingController(text: ' ');
    _model.textFieldRuaFocusNode ??= FocusNode();

    _model.textFieldBairroTextController ??= TextEditingController(text: ' ');
    _model.textFieldBairroFocusNode ??= FocusNode();

    _model.textFieldCidadeTextController ??= TextEditingController(text: ' ');
    _model.textFieldCidadeFocusNode ??= FocusNode();

    _model.textFieldUFTextController ??= TextEditingController(text: ' ');
